...
//         return console.log("item removed successfully = ", bucket[0]);
//       }
//       const samekeyItem = bucket.find((item) => item[0] === key);
//       if (samekeyItem) {
//         bucket.splice(bucket.indexOf(samekeyItem), 1);
//         return console.log("item removed successfully = ", samekeyItem);
//       }
//     }
//     return console.log("item not found");
//   }
...
// const h = new HashTable(45);

// h.add("name", "aju");
// h.add("amen", "aju");
// h.add("name", "ajmal");
// h.add("age", 18);
// h.add("dob", "14/12/2004");
// h.add("place", "calicut");
// h.remove("place");
// h.print();
...
//     if (typeof key === "string") {
//       return (
//         key.split("").reduce((pre, curr) => pre + curr.charCodeAt(), 0) %
//         this.size
//       );
//     }
//     return key % this.size;
...
//       if (samekeyItem) {
//         bucket.splice(bucket.indexOf(samekeyItem), 1);
//         return console.log("item deleted ", samekeyItem);
//       }
//     }
//     return console.log("item not found");
//   }
...
//     if (bucket) {
//       const samekeyItem = bucket.find((item) => item[0] === key);
//       if (samekeyItem) return console.log(samekeyItem[1]);
//     }
//     return console.log("item not found");
//   }
